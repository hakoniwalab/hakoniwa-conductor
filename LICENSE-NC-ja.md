...
本ライセンスは、以下の公開リポジトリから配布される「hakoniwa-conductor」プロジェクトのリリースパッケージに含まれる全てのバイナリファイルに適用されます。

https://github.com/hakoniwalab/hakoniwa-conductor/releases
...
本ライセンスで許可された利用に基づき、本ソフトウェアを用いて得られた研究結果、計測結果、ベンチマーク結果、図表および論文を公表することができます。
...
- コンサルティング、下請け、受託開発、システム統合プロジェクトでの使用
- 商用製品またはサービスの開発での使用
...
商用利用については、別途「箱庭コンダクタPRO」の商用ライセンスが必要です。

商用版では、契約条件に基づきソースコード、ドキュメントおよびバイナリーファイルを含むコンテンツが提供されます。
...
本ライセンスは日本国法に準拠し、これに従って解釈されます。本ライセンスに関連して生じる全ての紛争は、東京地方裁判所を第一審の専属的合意管轄裁判所とします。
